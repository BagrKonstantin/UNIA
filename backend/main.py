...
async def chat_endpoint(req: ChatRequest):
    ...
    if session_id not in conversations:
        ...
        system_msg = SystemMessage(content=(
            ...
            # "For transit routes, you need the arrival time and coordinates for both start and finish. "
            # "If the user doesn't provide coordinates, you can assume Campus Belval (49.504, 5.949) or Kirchberg (49.626, 6.159) as defaults where appropriate. "
                ...
                for tc in final_message.tool_calls:
                    ...
                    if tool_name in tool_mapping:
                        try:
                            ...
                            lc_messages.append(
                                ToolMessage(content=f"Error executing {tool_name}: {e}", tool_call_id=tool_id))
                    else:
